...
## ✅ Notes
- All surrogate keys (`*_key`) are used for dimensional joins.
- Dates are stored in `YYYY-MM-DD` format.
- Monetary values are stored in whole units for simplicity.
- This catalog supports star schema modeling for reporting and dashboarding.
